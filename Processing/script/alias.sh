...
alias su_hello="mr su_hello";alias su_num_ascii="run su_num_ascii"
alias su_num_alpha="run su_num_alpha"
...
alias hello="run hello";alias num_ascii="run num_ascii"
alias num_alpha="run num_alpha"
